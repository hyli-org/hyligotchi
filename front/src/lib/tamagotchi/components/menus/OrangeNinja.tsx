...
// Orange Ninja Screen Component
interface OrangeNinjaScreenProps {
  // No props needed for this simple menu
}

const OrangeNinjaScreen: React.FC<OrangeNinjaScreenProps> = () => {
  return (
    <div style={{
      width: '100%',
      height: '100%',
      ...
      {/* Orange Ninja Menu Title - more blocky */}
      <div style={{
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '8%' }}>ORANGE NINJA</div>
...
export default OrangeNinjaScreen; 